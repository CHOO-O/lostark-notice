...
월/화/목/금/토/일 10:30 KST에 schedule로 실행됩니다. 수요일은 중복 실행을 막기 위해 schedule에서 제외합니다.

```yaml
schedule:
  - cron: "30 1 * * 0,1,2,4,5,6"
```
...
daily-notice는 오전 10시 30분에 실행되므로 일반적으로 오늘 날짜와 같지만, 내부 로직은 초기화 시간 기준을 반영합니다.
